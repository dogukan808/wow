...
class SendSms():
    ...
    def Dsmartgo(self):
        ...
        try:
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Gönderilemedi ➩  dsmartgo.com.tr")

        except AttributeError:

            print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! ➩  dsmartgo.com.tr")
    ...
    def Kigili(self):    
        ...
        try:
            ...
            if kigili.status_code == 202:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! ➩  kigili.com")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Gönderilemedi ➩  kigili.com")
    ...
    def KahveDunyasi(self):    
        ...
        try:    
            ...
            if len(kahve_dunyasi.json()["meta"]["messages"]["error"]) == 0:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! ➩  core.kahvedunyasi.com")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Gönderilemedi ➩  core.kahvedunyasi.com")
    ...
    def NaosStars(self):
        ...
        try:
            ...
            if naosstars.status_code == 202:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! ➩  shop.naosstars.com")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Gönderilemedi ➩  shop.naosstars.com")
    ...
    def Wmf(self):
        ...
        try:
            ...
            if wmf.status_code == 202:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! ➩  wmf.com.tr")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Gönderilemedi ➩  wmf.com.tr")
    ...
    def IsteGelsin(self):
        ...
        try:
            ...
            if (r.json()["data"]["sendOtp2"]["alreadySent"]) == False:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! ➩  prod.fasapi.net")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Gönderilemedi ➩  prod.fasapi.net")
    ...
    def Bim(self):
        ...
        try:
            ...
            if bim.status_code == 200:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! ➩  bim.veesk.net")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Gönderilemedi ➩  bim.veesk.net")
    ...
    def Sok(self):
        ...
        try:
            ...
            if len(r.json()["meta"]["messages"]["success"]) != 0:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! ➩  api.ceptesok.com")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Gönderilemedi ➩  api.ceptesok.com")
    ...
    def Tiklagelsin(self):
        ...
        try:
            ...
            if tiklagelsin.json()["data"]["generateOtp"] == True:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! ➩  svc.apps.tiklagelsin.com")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Gönderilemedi ➩  svc.apps.tiklagelsin.com")
    ...
    def Migros(self):
        ...
        try:
            ...
            if migros.json()["successful"] == True:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! ➩  rest.migros.com.tr")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Gönderilemedi ➩  rest.migros.com.tr")
    ...
    def A101(self):
        ...
        try:
            ...
            if (r.status_code) == 200:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! ➩  a101.com.tr")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Gönderilemedi ➩  a101.com.tr")
    ...
    def Englishhome(self):
        ...
        try:
            ...
            if home.status_code == 202:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! ➩  englishhome.com")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Gönderilemedi ➩  englishhome.com")
    ...
    def Sakasu(self):
        ...
        try:
            ...
            if su.json()["status"] == "ok":
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! ➩  sakasu.com.tr")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Gönderilemedi ➩  sakasu.com.tr")
    ...
    def Rentiva(self): 
        ...
        try:
            ...
            if rentiva.json()["success"] == True:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! ➩  rentiva.com")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Gönderilemedi ➩  rentiva.com")
    ...
    def Bineq(self):
        ...
        try:
            ...
            if bineq.json()["IsSuccess"] == True:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! ➩  bineqapi.heymobility.tech")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Gönderilemedi ➩  bineqapi.heymobility.tech")
    ...
    def Link(self):
        ...
        try:
            ...
            if link.json()["detail"] == "Ok":
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! ➩  consumer-auth.linkfleet.de")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Gönderilemedi ➩  consumer-auth.linkfleet.de")
    ...
    def Lonca(self):
        ...
        try:
            ...
            if lonca.status_code == 200:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! ➩  loncamarket.com")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Gönderilemedi ➩  loncamarket.com")   
    ...
    def Dgn(self):
        ...
        try:
            ...
            if dgn.status_code == 200:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! ➩  odeme.dgnonline.com")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Gönderilemedi ➩  odeme.dgnonline.com")  
    ...
    def Yaani(self):
        ...
        try:
            ...
            if r.status_code == 204:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! ➩  api.yaanimail.com")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Gönderilemedi ➩  api.yaanimail.com")  
    ...
    def Defacto(self):
        ...
        try:
            ...
            if r.json()["Data"]["IsSMSSend"] == True:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! ➩  defacto.com.tr")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Gönderilemedi ➩  defacto.com.tr")
    ...
    def Mopas(self):
        ...
        try:
            ...
            if r.status_code == 200:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! ➩  mopas.com.tr")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Gönderilemedi ➩  mopas.com.tr")
    ...
    def Icq(self):
        ...
        try:
            ...
            if r.json()["status"]["code"] == 20000:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! ➩  u.icq.net")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Gönderilemedi ➩  u.icq.net")
    ...
    def Boyner(self):
        ...
        try:
            ...
            if r.json()["Success"] == True:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! ➩  boyner.com")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Gönderilemedi ➩  boyner.com")
    ...
    def Watsons(self):
        ...
        try:
            ...
            if r.status_code == 201:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! ➩  watsons.com.tr")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Gönderilemedi ➩  watsons.com.tr")
    ...
    def Buyur(self):
        ...
        try:
            ...
            if (r.status_code) == 200:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! ➩  app.buyursungelsin.com")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Gönderilemedi ➩  app.buyursungelsin.com")
    ...
    def Osmanlideal(self):
        ...
        try:
            ...
            if r.status_code == 200:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! ➩  osmgck.idealdata.com.tr")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Gönderilemedi ➩  osmgck.idealdata.com.tr")
    ...
    def Pinar(self):
        ...
        try:
            ...
            if r.text == "true":
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! ➩  pinarsumobileservice.yasar.com.tr")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Gönderilemedi ➩  pinarsumobileservice.yasar.com.tr")
    ...
    def Suiste(self):
        ...
        try:
            ...
            if r.json()["code"] == "common.success":
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! ➩  suiste.com")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Gönderilemedi ➩  suiste.com")
    ...
    def Hayat(self):
        ...
        try:
            ...
            if (r.json()["IsSuccessful"]) == True:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! ➩  hayatsu.com.tr")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Gönderilemedi ➩  hayatsu.com.tr")
    ...
    def Pisir(self):
        ...
        try:
            ...
            if r.json()["ok"] == "1":
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! ➩  api.pisir.com")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Gönderilemedi ➩  api.pisir.com")
    ...
    def KimGb(self):
        ...
        try:
            ...
            if r.status_code == 200:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! ➩  3uptzlakwi.execute-api.eu-west-1.amazonaws.com")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Gönderilemedi ➩  3uptzlakwi.execute-api.eu-west-1.amazonaws.com")
    ...
    def IkinciYeni(self):
        ...
        try:
            ...
            if (r.json()["isSucceed"]) == True:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! ➩  apigw.ikinciyeni.com")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Gönderilemedi ➩  apigw.ikinciyeni.com")
    ...
    def Terra(self):
        ...
        try:
            ...
            if (r.status_code) == 201:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! ➩  api.terrapizza.com.tr")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Gönderilemedi ➩  api.terrapizza.com.tr")
    ...
    def IpraGaz(self):
        ...
        try:
            ...
            if (r.json()["phoneNumber"]) == str(self.phone):
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! ➩  ipapp.ipragaz.com.tr")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Gönderilemedi ➩  ipapp.ipragaz.com.tr")
    ...
    def Mogaz(self):
        ...
        try:
            ...
            if (r.json()["messageCode"]) == "OK":
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! ➩  mogazmobilapinew.aygaz.com.tr")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Gönderilemedi ➩  mogazmobilapinew.aygaz.com.tr")
    ...
    def GoMobile(self):
        ...
        try:
            ...
            if (r.json()["data"]["success"]) == True:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! ➩  gomobilapp.ipragaz.com.tr")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Gönderilemedi ➩  gomobilapp.ipragaz.com.tr")
    ...
    def PetrolOfisi(self):
        ...
        try:
            ...
            if r.status_code == 204:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! ➩  mobilapi.petrolofisi.com.tr")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Gönderilemedi ➩  mobilapi.petrolofisi.com.tr")
    ...
    def Total(self):
        ...
        try:
            ...
            if (r.json()["success"]) == True:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! ➩  mobileapi.totalistasyonlari.com.tr")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Gönderilemedi ➩  mobileapi.totalistasyonlari.com.tr")
    ...
    def Opet(self):
        ...
        try:
            ...
            if (r.status_code) == 200:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! ➩  api.opet.com.tr")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Gönderilemedi ➩  api.opet.com.tr")
    ...
    def Dolap(self):
        ...
        try:
            ...
            if r.status_code == 200:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! ➩  api-gateway.dolap.com")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Gönderilemedi ➩  api-gateway.dolap.com")
    ...
    def Hey(self):
        ...
        try:
            ...
            if (r.json()["IsSuccess"]) == True:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! ➩  heyapi.heymobility.tech")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Gönderilemedi ➩  heyapi.heymobility.tech")
    ...
    def Tazi(self):
        ...
        try:
            ...
            if (r.json()["kod"]) == "0000":
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! ➩  mobileapiv2.tazi.tech")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Gönderilemedi ➩  mobileapiv2.tazi.tech")
    ...
    def Isbike(self):
        ...
        try:
            ...
            if (r.json()["sonuc"]["aciklama"]) == "İşlem Başarılı":
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! ➩  app.isbike.istanbul")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Gönderilemedi ➩  app.isbike.istanbul")
    ...
    def N11(self):
        ...
        try:
            ...
            if (r.json()["isSuccess"]) == True:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! ➩  mobileapi.n11.com")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Gönderilemedi ➩  mobileapi.n11.com")
    ...
    def Joker(self):
        ...
        try:
            ...
            if (r.json()["success"]) == True:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! ➩  joker.com.tr")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Gönderilemedi ➩  joker.com.tr")
    ...
    def Ebebek(self):
        ...
        try:
            ...
            if r.json()["status"] == "SUCCESS":
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! ➩  api2.e-bebek.com")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Gönderilemedi ➩  api2.e-bebek.com")
    ...
    def Saka(self):
        ...
        try:
            ...
            if (r.json()["status"]) == 1 :
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! ➩  mobilcrm2.saka.com.tr")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Gönderilemedi ➩  mobilcrm2.saka.com.tr")
    ...
    def Gofody(self):
        ...
        try:
            ...
            if (r.json()["success"]) == True:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! ➩  backend.gofody.com")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Gönderilemedi ➩  backend.gofody.com")
    ...
    def Madame(self):
        ...
        try:
            ...
            if (r.status_code) == 202:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! ➩  madamecoco.com")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Gönderilemedi ➩  madamecoco.com")
    ...
    def Buludag(self):
        ...
        try:
            ...
            if r.status_code == 200:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! ➩  bilet.balikesiruludag.com.tr")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Gönderilemedi ➩  bilet.balikesiruludag.com.tr")   
    ...
    def Evidea(self):
        ...
        try:
            ...
            if r.status_code == 202:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! ➩  evidea.com")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Gönderilemedi ➩  evidea.com")
    ...
    def Koctas(self):
        ...
        try:
            ...
            if (r.json()["status"]) == True:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! ➩  occ2.koctas.com.tr")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Gönderilemedi ➩  occ2.koctas.com.tr")
    ...
    def Gratis(self):
        ...
        try:
            ...
            if (r.status_code) == 200:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! ➩  ivt.mobildev.com")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Gönderilemedi ➩  ivt.mobildev.com")
    ...
    def Anadolu(self):
        ...
        try:
            ...
            if r.status_code == 200:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! ➩  anadolu.com.tr")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Gönderilemedi ➩  anadolu.com.tr")
    ...
    def Accordors(self):
        ...
        try:
            ...
            if r.json()["data"]:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! ➩  aouws.accordors.com")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Gönderilemedi ➩  aouws.accordors.com")
    ...
    def Marti(self):
        ...
        try:
            ...
            if r.json()["isSuccess"] == True:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! ➩  customer.martiscooter.com")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Gönderilemedi ➩  customer.martiscooter.com")
    ...
    def Hop(self):
        ...
        try:
            ...
            if r.status_code == 201:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! ➩  api.hoplagit.com")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Gönderilemedi ➩  api.hoplagit.com")
    ...
    def Karma(self):
        ...
        try:
            ...
            if r.status_code == 201:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Gönderildi! ➩  api.gokarma.app")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Gönderilemedi ➩  api.gokarma.app")
